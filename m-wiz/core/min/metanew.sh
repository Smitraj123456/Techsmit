...
echo -e "
 ...
 ┃THANK YOU FOR┃ ------------------------------------
 ┃ USING M-WIZ ┃ |$grn FOLLLOW:$cod https://www.instagram.com/lovely_singh__kahlon $grn|$grn
 ┃             ┃ |$grn SUBSCRIBE:$cod Technical Mundeer          $grn|$grn
 ┃             ┃ |$grn CHAT:$cod    https://telegram.me/technical_mundeer     $grn|$grn
 ┃  ( ͡❛ ͜ʖ ͡❛)   ┃ ------------------------------------$grn
 ┃             ┃
 ┃ Technical Mundeer┃ $blu METASPLOIT REQUIRES$grn 1GB$blu STORAGE $grn
